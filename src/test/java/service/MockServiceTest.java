...
public class MockServiceTest {
    ...
    @Test
    public void shouldTwoTimesInvocationForceGetChampionName()
    {
        Champion champion = mock(Champion.class);
    ...
    // 4-2. champion 객체에서 이름을 가져오는 로직이 최대 3번까 실행되면 Pass 하는 로직을 작성하세요.
    @Test
    public void shouldThreeTimesInvocationForceGetChampionName()
    {
        Champion champion = mock(Champion.class);
