...
public class ChampionTest {
    ...
    public void givenCollectionWhenEmptyCorrect() {
        ...
        List<String> emptyList1 = new ArrayList<>();//add
        emptyList1.add("Hi");//add
        assertThat(emptyList1, empty());//add
    }
    ...
    public void notNullCheck() {
        ...
        String testnull = null;//add
        assertThat(testnull, nullValue());//add
    }
    ...
    public void testForFloatingPoint() {
        ...
        assertThat(8.5, closeTo(7, 0.6));//add
    }
    ...
    public void shouldSupportChampionIsTaric() {
        ...
        Champion midChamp = new Champion("야스오", "미드");//add
        assertThat("야스오", is(midChamp.getName()));//add
        assertThat("야스오", is(equalTo(midChamp.getName())));//add
        assertThat("야스오", equalTo(midChamp.getName()));//add
    }
    ...
    public void shouldHasPropertyPosition() {
        ...
        assertThat(championList.get(3), hasProperty("position", equalTo("미드")));//add
    }
    ...
    public void shouldHaveSomeChampName() {
        ...
        List<String> champListNames1 = Arrays.asList("레넥톤", "야스오", "티모", "직스", "나르", "나미");//add
        assertThat(champListNames1.get(2), hasToString("티모"));//add
    }
    ...
    public void shouldHaveSamePropertyAndValue() {
        ...
        List<String> championNames3 = Arrays.asList("레넥톤", "야스오", "티모", "직스", "나르", "나미");//add
        assertThat(championNames3, samePropertyValuesAs(championNames1));//add
    }
